...
export const colors = {
  snapline: "#ffffff",
  altRouteline: "#ffffff",
  routelineFoot: "#ffffff",
  routelineBike: "#ffffff",
  routeline: "#ffffff",
  congestionLow: "#ffffff",
  congestionHigh: "#ffffff",
  hoverpoint: "#ffffff",
  snappoint: "#ffffff",
  snappointHighlight: "#ffffff",
  waypointFoot: "#ffffff",
  waypointFootHighlight: "#ffffff",
  waypointBike: "#ffffff",
  waypointBikeHighlight: "#ffffff",
  waypoint: "#ffffff",
  waypointHighlight: "#ffffff",
};
